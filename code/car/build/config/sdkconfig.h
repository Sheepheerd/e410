...
#define CONFIG_IDF_TOOLCHAIN "clang"
#define CONFIG_IDF_TOOLCHAIN_CLANG 1
...
#define CONFIG_COMPILER_RT_LIB_CLANGRT 1
#define CONFIG_COMPILER_RT_LIB_NAME "clang_rt.builtins"
